<script lang="ts">
	...
	const updatePoolInfo = () => {
		...
		// ! rpc call (once)
		getRaydiumPoolInfo(app.raydiumClient, $page.url.searchParams.get('poolId') || '').then(
			(poolInfo) => {
...
{#if pool}
	<div class="p-8">
		<div class="flex flex-row justify-center">
			<OpenPositionPanel {pool} {poolRpcData} {poolKeys} {tokenBalances} />
			<div class="ml-5">
				<PoolInfoPanel {pool} />
			</div>
		</div>
